       ...
       client.on('interactionCreate', async interaction => {
         ...
         if (interaction.customId === "rerolls") {
           ...
           Math.floor(Math.random() * db.get(`kullanıcı_${interaction.message.id}`).length)
             ...
             .setCustomId('form')
             .setTitle('Nexus Destek - Destek Sistemi!')
             ...
             const embed = new EmbedBuilder()
             .setTitle("Nexus Destek - Kullanıcı Paneli!")
...
.setCustomId('form13')
.setTitle('.Nexus RP - Menülü Rol Alma Sistemi!')
...
value: "s2"
    ...
    const embed = new EmbedBuilder()
    .setTitle("Nexus RP - Rol Alma Sistemi!")
...
client.on("interactionCreate", async (interaction, message) => {
  ...
  if(interaction.customId === "yardım") {
    ...
    let message = interaction.message.id
      ...
      .setTitle("Nexus RP - Moderasyon Sistemi!")
    ...
    if (interaction.values[0] == "kullanıcı") { 
      ...
      const embed = new Discord.EmbedBuilder()
    .setTitle("Nexus RP - Kullanıcı Sistemi!")
  ...
  .setColor("#ff0000")
    ...
    if (interaction.values[0] == "giveaway") {
      ...
      const embed = new Discord.EmbedBuilder()
    .setTitle("Nexus RP - Çekiliş Sistemi!")
  ...
  .setColor("#ff0000")
    ...
    const embed = new Discord.EmbedBuilder()
  .setTitle("Nexus RP - Destek Sistemi!")
...
.setCustomId('formaq')
.setTitle('Nexus RP - Başvuru Formu!')
